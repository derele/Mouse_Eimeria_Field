...
## TRAPS TABLE *****************************
TrapTable_2014to2017 <- read.csv(file = "../raw_data/HZ17_Mice_Trap.csv")
TrapTable_2014to2017$Year <- 2017
...
trapsbefore17 <- trapsbefore17[trapsbefore17$Year != 2017,]
...
trapsbefore17$Team <- NA; trapsbefore17$Address <- NA; trapsbefore17$Date_set <- NA; trapsbefore17$Time_set <-NA
...
TrapTable_2014to2017 <- rbind(trapsbefore17, TrapTable_2014to2017)
