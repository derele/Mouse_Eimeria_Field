...
library(knitr)
kable(prevalencePCR, caption = "Prevalence of Eimeria per year, based on PCR detection and oocysts flotation. A mouse was considered infected by Eimeria if it had a positive oocyst count in its feces, or if one of the 3 markers (COI, 18S or ORF470) gave a sequence")
```
