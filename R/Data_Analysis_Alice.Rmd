...
```{r plot1, echo=FALSE, warning=FALSE, fig.width=5,fig.height=3,fig.cap="\\label{fig:plot1}Comparison of OPG depending on dilution level. Red line represents linear relationship between both axis, dotted line represents "}
plot1
```
