...
myVennDiagram3 <- function(data){      
  area1 = nrow(subset(data, delta_ct_MminusE > -6))
  area2 = nrow(subset(data, OPG > 0))
  ## areas of 2-group overlap
  cross.area = nrow(subset(data, delta_ct_MminusE > -6 & OPG > 0))
  grid.newpage()
  draw.pairwise.venn(area1 = area1, 
                     area2 = area2, 
                     cross.area = cross.area, 
...
```{r, echo = FALSE}
write.csv(myData, "../../Data_important/FinalFullDF_flotationPcrqPCR.csv", row.names = F)
```
