...
setwd("~/GitHub/Mouse_Eimeria_Field/data_input/qPCR_faeces_21/Results/Results_files/")
...
df_results <- dplyr::rename(df_results, Well_Position = "Well Position",
...
df_results <- df_results %>% mutate(Ct_index = case_when (Well_Position %in% c('A1', 'A4', 'A7', 'A10', 
                                                                               'B1', 'B4', 'B7', 'B10', 
                                                                               'C1', 'C4', 'C7', 'C10', 
                                                                               'D1', 'D4', 'D7', 'D10',
                                                                               'E1', 'E4', 'E7', 'E10',
...
write.csv(df_results, "data_input/FEC_EqPCR_DataProduct.csv", row.names=FALSE)
